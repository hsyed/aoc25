...
fn main() {
    ...
    match args.day {
        ...
        11 => {
            day11::solve_problem_1("input/day11.txt").unwrap();
            day11::solve_problem_2("input/day11.txt").unwrap();
        }
        12 => {
            day12::solve_problem_1("input/day12.txt").unwrap();
            day12::solve_problem_2("input/day12.txt").unwrap();
        }
